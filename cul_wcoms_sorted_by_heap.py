...
def transform_matrix(a, point):
    ...
    # print(a)
    # print(f"point:{point},center_a:{center_a}")
    # print(f"{start_index[0]}:{end_index[0]}, {start_index[1]}:{end_index[1]}")
...
def main():
    ...
    cover_clusters = np.zeros((len(clusters), 1000, 1000))
