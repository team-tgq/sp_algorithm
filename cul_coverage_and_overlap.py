...
datafilepath = "output/csv/our_filtered_clusters_data_point_0-06-49.408328.txt"
...
# 重叠率：总视域数组中网格点值为大于等于2的元素值的总和再减去数量总和(覆盖)，除以总视域数组点数
# 找出数组中所有大于等于2的元素
...
# 保存栅格数据为GeoTIFF
with rasterio.open(
        "output/gis/final/our_viewed_plain_210.tif", 'w', driver='GTiff',
