...
def analysis_by_spderl_simplified(x_center, y_center, h_center, radius, h_stand, horizontal_start_angle=0.0,
    ...
    x_grid_observe, y_grid_observe, dem_minx, dem_miny, x_grid_count, y_grid_count, see_height, x_grid_center, y_grid_center, min_x, max_x, min_y, max_y, is_in_grid_point = get_initial_param_spderl(
...
def analysis_by_xpderl(x_center, y_center, h_center, to_x, to_y, h_stand):
    # 初始化
    dem_minx, dem_miny, per_x, per_y, x_grid_count, y_grid_count, see_height, x_grid_center, y_grid_center, min_x, max_x, min_y, max_y, is_in_grid_point = get_initial_param(
...
def get_initial_param(x_center, y_center, h_center, to_x, to_y, h_stand):
    ...
    return dem_minx, dem_miny, per_x, per_y, x_grid_count, y_grid_count, see_height, x_grid_center, y_grid_center, min_x, max_x, min_y, max_y, is_in_grid_point
...
def get_initial_param_spderl(x_center, y_center, h_center, radius, h_stand):
    ...
    return x_grid_observe, y_grid_observe, dem_minx, dem_miny, x_grid_count, y_grid_count, see_height, x_grid_center, y_grid_center, min_x, max_x, min_y, max_y, is_in_grid_point
